...
int all_file_test_portfolio[200][50];//測試期投資組合
int all_file_gbest_portfolio[200][50];//最後投資組合
double all_test_period_trend_ratio[200];
double all_file_test_return[200];
double all_file_test_risk[200];
...
void total_test_period(int a)
{
	string ouput_file = "Larry_H#_test_Gbest_10000_10_50_0.0004.csv";//輸出檔案名稱
